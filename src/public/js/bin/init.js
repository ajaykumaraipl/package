...
//    $('.parallax').parallax();
    ...
    var abc = $('.sidenav-main').sidenav();
       
    var instance = M.Sidenav.getInstance(abc);
 

 $('#sidenavMain').click(function(){
      if(instance.isOpen){
        instance.close();
 } else {
      instance.open();
...
//
//var $distributors_sidenav = $('.distributors-sidenav').sidenav();
//var distributors_sidenav_instance = M.Sidenav.getInstance($distributors_sidenav);
// $('#sidenav-trigger-dist').click(function(){
//      if(distributors_sidenav_instance.isOpen){
//        distributors_sidenav_instance.close();
// } else {
//      distributors_sidenav_instance.open();
// }
// })
 
/*new*/
//var $filter_sidenav = $('.filters-bar').sidenav();
//var filter_sidenav_instance = M.Sidenav.getInstance($filter_sidenav);
// $('#filter-trigger').click(function(){
//     console.log("filter-trigger");
//      if(filter_sidenav_instance.isOpen){
//        filter_sidenav_instance.close();
// } else {
//      filter_sidenav_instance.open();
// }
// })
...
//        console.log("thids fisdufdis");
//    console.log(instances.options);
