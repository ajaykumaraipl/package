                                        ...
                                        <tbody>
                                            @foreach ($allCategories as $category)
                                                <tr role="row" class="odd">
                                                    <td tabindex="0">
                                                        <span data-order="2019-06-21 00:00:00">
                                                                {!! $category->name ?: '<font style="color:red"> No Data</font>' !!}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span>{!! $category->description ?: '<font style="color:red"> No Data</font>' !!}</span>
                                                    </td>
                                                    <td>
                                                        <!-- Single edit button -->
                                                        ...
                                                        <a href={{ url("/categories/delete/$category->id") }} class="btn btn-xs btn-default" data-button-type="delete">
