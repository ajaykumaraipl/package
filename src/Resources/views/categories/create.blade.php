        ...
        <section class="content">
            ...
            <div class="row m-t-20">
                <div class="col-md-8 col-md-offset-2" style="margin: 0 auto;">
                    <!-- Default box -->
                    <form class="text-center border border-light p-5" method="post" action="{{ url('/categories/save') }}" enctype="multipart/form-data">
                        @csrf
                        <p class="h4 mb-4 text-muted">Create Category</p>
